...
from core.gl.models import Company
import core._utils
...
def csv_to_modelattr(open_file, name_cleaner=None, company=core._utils.get_default_company()):
...
def create_instance(row, model, name_cleaner=None, value_cleaner=None, unique=None, exclude=[], company=core._utils.get_default_company()):
    row['company'] = company
