...
class Week(models.Model):
    ...
    start_month = models.ForeignKey(Month, related_name='start_week_set')
    end_month = models.ForeignKey(Month, related_name='end_week_set')
...
class Day(models.Model):
    ...
    month = models.ForeignKey(Month, db_index=True)
    quarter = models.ForeignKey(Quarter, db_index=True)
    year = models.ForeignKey(Year, db_index=True)
    def __unicode__(self):
